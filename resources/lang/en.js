export default {
	title: "Corona age statistics for Switzerland and FL",
	timespan: "The Swiss Federal Office of Public Health publishes the numbers till the past week. The data which is used on this site is from <span class=\"update_date\"></span>. The population is also extracted from the statistics and is actually <span class=\"population\"></span> people.",
	...
	label: {
		...
		total: "Total",
		years: "years",
		corona_cases: "Corona Cases",
		corona_hospitalization: "Corona Hospitalization",
		corona_deaths: "Corona Deaths",
		vaccinated: "Vaccinated",
		vaccinated_hospitalization: "Vaccinated Hospitalization",
		vaccinated_deaths: "Vaccinated Deaths",
